...
<div align="center">
    ...
    <input type="submit" value="Approve" onclick="document.location.href='approveStd.php'">&nbsp;<input type="submit" value="Report" onclick="document.location.href='report.php'">

<form method="post">
<table width="1200" border="1">
  <tbody>
    <tr>
      <td colspan="3" bgcolor="#85C1E9"><center><font size="+2"><strong style="color: #FFFFFF">Administrator Control Panel</strong></font></center><div align="right"><input type="submit" value="Logout" name="logout"></div></td>
    </tr>
