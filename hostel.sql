...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 02, 2019 at 08:34 PM
...
CREATE TABLE `hostel` (
  ...
  `hostelappend` varchar(255) NOT NULL,
...
INSERT INTO `hostel` (`req_id`, `id`, `hostelname`, `hostelblock`, `hostelappend`, `reqdate`, `appstatus`, `reason`) VALUES
(1, 37, 'kolej kediaman 3', 'c13', 'I want to apply for hostel.', '2019-11-19', 'APPROVED', NULL),
(8, 38, 'Kolej Kediaman 1', 'A', 'Saya saja je', '2019-12-02', 'pending', NULL);
...
(37, 'kinah', 'fc5e038d38a57032085441e7fe7010b0', 'alala@123.com', 'f', 123456789, 'sayacomel'),
(38, 'azizi', '237b13b0d958f894728dd9585c0751ec', 'azizifahmi.ar@gmail.com', 'm', 999, 'UMP');
...
--
ALTER TABLE `hostel`
  ADD CONSTRAINT `hostel_ibfk_1` FOREIGN KEY (`id`) REFERENCES `users` (`id`);
COMMIT;
